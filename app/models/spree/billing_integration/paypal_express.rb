class Spree::BillingIntegration::PaypalExpress < Spree::BillingIntegration
  attr_accessible :preferred_login, :preferred_password, :preferred_signature, :preferred_review, :preferred_no_shipping, :preferred_server, :preferred_test_mode, :preferred_currency, :preferred_allow_guest_checkout
